...
// parent.document.getElementById('you-image-user2').contentWindow.location.reload();
//
// parent.document.getElementById('other-image-user1').contentWindow.location.reload();
// var iframe = parent.document.getElementById("you-image-user1");
// var iframeContent = (iframe.contentWindow || iframe.contentDocument);
// iframeContent.draw_generalisations(trialdata, [], posit_ix, 'you-image-user1');

function draw_generalisations(data, hovered, div_id) {
